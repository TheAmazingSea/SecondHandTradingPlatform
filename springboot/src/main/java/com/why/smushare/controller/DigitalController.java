...
import com.why.smushare.entity.Digital;
import com.why.smushare.mapper.DigitalMapper;
...
public class DigitalController {
    ...
    public Result save(@RequestBody Digital digital){
        digital.setAllow("0");
    ...
    @PutMapping
    //@RequestBody就是把前台传过来的json数据转换成Java对象
    public Result update(@RequestBody Digital digital){
        digital.setAllow("0");
        digitalMapper.updateById(digital);
        return Result.success();
    }
    ...
    public Result<?> findPage(@RequestParam(defaultValue = "1") Integer pageNum,
        ...
        QueryWrapper<Digital> wrapper = new QueryWrapper<>();
        wrapper.like("name",search);
        wrapper.eq("allow","1");
        return Result.success(digitalMapper.selectPage(new Page<>(pageNum, pageSize),wrapper));
    }
